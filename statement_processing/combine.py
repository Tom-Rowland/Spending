...
if __name__ == '__main__':
    ...
    #personalStarling = pd.read_csv('data/4 staging to combine/personalStarling.csv')
    ...
    #personalStarling = personalStarling.loc[:,['Date','Description','Amount','Category','Subcategory']]

    #combined = pd.concat([personal,joint,personalStarling], ignore_index=True)
